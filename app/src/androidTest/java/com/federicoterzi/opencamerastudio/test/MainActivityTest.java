package com.federicoterzi.opencamerastudio.test;
...
import com.federicoterzi.opencamerastudio.PanoramaProcessorException;
import com.federicoterzi.opencamerastudio.cameracontroller.CameraController2;
import com.federicoterzi.opencamerastudio.HDRProcessor;
import com.federicoterzi.opencamerastudio.HDRProcessorException;
import com.federicoterzi.opencamerastudio.ImageSaver;
import com.federicoterzi.opencamerastudio.MainActivity;
import com.federicoterzi.opencamerastudio.MyApplicationInterface;
import com.federicoterzi.opencamerastudio.PreferenceKeys;
import com.federicoterzi.opencamerastudio.preview.VideoProfile;
import com.federicoterzi.opencamerastudio.SaveLocationHistory;
import com.federicoterzi.opencamerastudio.cameracontroller.CameraController;
...
import com.federicoterzi.opencamerastudio.ui.PopupView;
...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    private void switchToFlashValue(String required_flash_value) {
        if( mPreview.supportsFlash() ) {
            ...
            if( !flash_value.equals(required_flash_value) ) {
                ...
                View popupButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.popup);
    ...
    private void switchToISO(int required_iso) {
        ...
        if( iso != required_iso ) {
            ...
            View exposureButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure);
            View exposureContainer = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_container);
    ...
    private void setToDefault() {
        ...
        if( mPreview.isVideo() ) {
            ...
            View switchVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.switch_video);
        ...
        if( mPreview.getCameraControllerManager().getNumberOfCameras() > 1 ) {
            ...
            while( cameraId != 0 ) {
                View switchCameraButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.switch_camera);
    ...
    private void subTestSaveVideoMode() {
        ...
        View takePhotoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.take_photo);
        View switchVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.switch_video);

        assertTrue(!mPreview.isVideo());
        assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.take_photo) ) );
        assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.switch_to_video) ) );

        clickView(switchVideoButton);
        waitUntilCameraOpened();
        assertTrue(mPreview.isVideo());
        assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.start_video) ) );
        assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.switch_to_photo) ) );
    ...
    private void subTestExposureLockNotSaved() {
        ...
        View exposureLockButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_lock);
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.exposure_lock) ) );
        clickView(exposureLockButton);
        assertTrue(mPreview.getCameraController().getAutoExposureLock());
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.exposure_unlock) ) );
        ...
        restart();
        assertTrue(!mPreview.getCameraController().getAutoExposureLock());
        exposureLockButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_lock);
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.exposure_lock) ) );
    }
    ...
    private void subTestWhiteBalanceLockNotSaved() {
        ...
        View whiteBalanceLockButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.white_balance_lock);
        ...
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.white_balance_lock) ) );
        clickView(whiteBalanceLockButton);
        assertTrue(mPreview.getCameraController().getAutoWhiteBalanceLock());
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.white_balance_unlock) ) );
        ...
        restart();
        assertTrue(!mPreview.getCameraController().getAutoWhiteBalanceLock());
        whiteBalanceLockButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.white_balance_lock);
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.white_balance_lock) ) );
    }
    ...
    public void testFlashVideoMode() {
        ...
        restart();
        switchVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.switch_video);
        assertTrue(mPreview.isVideo());
        assertTrue(mPreview.getCurrentFlashValue().equals("flash_off"));
    ...
    public void testFaceDetection() throws InterruptedException {
        ...
        View faceDetectionButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.face_detection);
        ...
        */
        ...
        assertTrue( faceDetectionButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.face_detection_disable) ) );
        ...
        restart();
        faceDetectionButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.face_detection);
        ...
        assertTrue( faceDetectionButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.face_detection_enable) ) );
    ...
    private void subTestPopupButtonContentDescription(int title_id, String test_key, boolean next, boolean expected) {
        ...
        if( button != null ) {
            ...
            String next_string = mActivity.getResources().getString(next ? com.federicoterzi.opencamerastudio.R.string.next : com.federicoterzi.opencamerastudio.R.string.previous);
    ...
    public void testSwitchVideo() {
        ...
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_resolution, "PHOTO_RESOLUTIONS", false, true);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_resolution, "PHOTO_RESOLUTIONS", true, false);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_timer, "TIMER", false, false);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_timer, "TIMER", true, true);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_burst_mode, "REPEAT_MODE", false, false);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_burst_mode, "REPEAT_MODE", true, true);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.grid, "GRID", false, true);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.grid, "GRID", true, true);
        ...
        Log.d(TAG, "popup is now open");
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.video_quality, "VIDEO_RESOLUTIONS", false, true);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.video_quality, "VIDEO_RESOLUTIONS", true, false);
        if( mActivity.getApplicationInterface().getSupportedVideoCaptureRates().size() > 1 ) {
            subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_video_capture_rate, "VIDEOCAPTURERATE", false, false);
            subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_video_capture_rate, "VIDEOCAPTURERATE", true, true);
        }
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_timer, "TIMER", false, false);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_timer, "TIMER", true, true);
        subTestPopupButtonContentDescription(com.federicoterzi.opencamerastudio.R.string.preference_burst_mode, "REPEAT_MODE", false, false);
    ...
    public void testTakePhotoExposureCompensation() throws InterruptedException {
        ...
        View exposureButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure);
        View exposureContainer = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_container);
        SeekBar seekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_seekbar);
    ...
    public void testTakePhotoManualISOExposure() throws InterruptedException {
        ...
        View exposureButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure);
        View exposureContainer = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.manual_exposure_container);
        SeekBar isoSeekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.iso_seekbar);
        SeekBar exposureTimeSeekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_time_seekbar);
        assertTrue(exposureButton.getVisibility() == View.VISIBLE);
        assertTrue(exposureContainer.getVisibility() == View.GONE);
    ...
    public void testTakePhotoManualWB() throws InterruptedException {
        ...
        SeekBar white_balance_seek_bar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.white_balance_seekbar);
        ...
        */
        ...
        View exposureContainer = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_container);
        SeekBar seekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.exposure_seekbar);
        View manualWBContainer = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.manual_white_balance_container);
        SeekBar seekBarWB = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.white_balance_seekbar);
    ...
    public void testAudioControlIcon() {
        ...
        View audioControlButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.audio_control);
        ...
        audioControlButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.audio_control);
    ...
    private void waitForTakePhoto() {
        ...
        View audioControlButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.audio_control);
        View popupButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.popup);
        View trashButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.trash);
        View shareButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.share);
    ...
    public void testTakePhotoFrontCamera() throws InterruptedException {
        ...
        assertTrue(cameraId != new_cameraId);
        assertTrue( contentDescription.equals( mActivity.getResources().getString(new_is_front_facing ? com.federicoterzi.opencamerastudio.R.string.switch_to_front_camera : com.federicoterzi.opencamerastudio.R.string.switch_to_back_camera) ) );
        assertTrue( new_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? com.federicoterzi.opencamerastudio.R.string.switch_to_front_camera : com.federicoterzi.opencamerastudio.R.string.switch_to_back_camera) ) );
        subTestTakePhoto(false, false, true, true, false, false, false, false);
        ...
        assertTrue( restart_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? com.federicoterzi.opencamerastudio.R.string.switch_to_front_camera : com.federicoterzi.opencamerastudio.R.string.switch_to_back_camera) ) );
    ...
    public void testTakePhotoManualFocus() throws InterruptedException {
        ...
        SeekBar seekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.focus_seekbar);
    ...
    public void testImmersiveMode() throws InterruptedException {
        ...
        View trashButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.trash);
        View shareButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.share);
        View zoomSeekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.zoom_seekbar);
        View takePhotoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.take_photo);
        View pauseVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.pause_video);
        View takePhotoVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.take_photo_when_video_recording);
        assertTrue(switchCameraButton.getVisibility() == View.VISIBLE);
        assertTrue(switchVideoButton.getVisibility() == View.VISIBLE);
        int exposureVisibility = exposureButton.getVisibility();
        int exposureLockVisibility = exposureLockButton.getVisibility();
    ...
    private int subTestTakeVideo(boolean test_exposure_lock, boolean test_focus_area, boolean allow_failure, boolean immersive_mode, VideoTestCallback test_cb, long time_ms, boolean max_filesize, boolean subtitles) throws InterruptedException {
        ...
        View switchVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.switch_video);
        if( mPreview.isVideo() ) {
            assertTrue( (Integer)takePhotoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_video_selector );
            assertTrue( (Integer)switchVideoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_photo );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.start_video) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.pause_video) ) );
            assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.switch_to_photo) ) );
        }
        else {
            assertTrue( (Integer)takePhotoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_photo_selector );
            assertTrue( (Integer)switchVideoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_video );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.take_photo) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.pause_video) ) );
            assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.switch_to_video) ) );
        }
        ...
        if( mPreview.isVideoRecording() ) {
            assertTrue( (Integer)takePhotoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_video_recording );
            assertTrue( (Integer)switchVideoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_photo );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.stop_video) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.pause_video) ) );
        ...
        assertTrue( (Integer)takePhotoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_video_selector );
        assertTrue( (Integer)switchVideoButton.getTag() == com.federicoterzi.opencamerastudio.R.drawable.take_photo );
        assertEquals( takePhotoButton.getContentDescription(), mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.start_video) );
        assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.pause_video) ) );
    ...
    public void testTakeVideoPause() throws InterruptedException {
        ...
        final View pauseVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.pause_video);
        assertTrue( pauseVideoButton.getVisibility() == View.GONE );
        ...
        subTestTakeVideo(false, false, false, false, new VideoTestCallback() {
            ...
            public int doTest() {
                ...
                assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(com.federicoterzi.opencamerastudio.R.string.resume_video) ) );
                assertTrue( pauseVideoButton.getVisibility() == View.VISIBLE );
                assertTrue( mPreview.isVideoRecording() );
                assertTrue( mPreview.isVideoRecordingPaused() );
    ...
    private void subTestTakeVideoSnapshot() throws InterruptedException {
        ...
        final View takePhotoVideoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.take_photo_when_video_recording);
        assertTrue( takePhotoVideoButton.getVisibility() == View.GONE );
    ...
    public void testTakeVideoSettings() throws InterruptedException {
        ...
        // now go to settings
        View settingsButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.settings);
    ...
    private void subTestTimer(int type) {
        ...
        try {
            ...
            takePhotoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.take_photo);
    ...
    public void testPopupLeftLayout() {
        ...
        View popup_view = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.popup_container);
    ...
    public void testRightLayout() {
        ...
        View settingsButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.settings);
        View galleryButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.gallery);
    ...
    public void testPopupLayout() throws InterruptedException {
        ...
        for(int i=0;i<50;i++) {
            View popup_container = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.popup_container);
            View popupButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.popup);
            final float scale = mActivity.getResources().getDisplayMetrics().density;
    ...
    public void testZoom() {
        ...
        final ZoomControls zoomControls = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.zoom);
        assertTrue(zoomControls.getVisibility() == View.GONE);

        final SeekBar zoomSeekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.zoom_seekbar);
        assertTrue(zoomSeekBar.getVisibility() == View.VISIBLE);
    ...
    private void setUpFocusBracketing() throws InterruptedException {
        SeekBar focusSeekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.focus_seekbar);
        SeekBar focusTargetSeekBar = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.focus_bracketing_target_seekbar);
    ...
    private void subTestTakePhotoContinuousBurst(boolean is_slow) throws InterruptedException {
        ...
        final View takePhotoButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.take_photo);
        Log.d(TAG, "about to click take photo");
        mActivity.runOnUiThread(new Runnable() {
            public void run() {
    ...
    private void subTestTakePhotoPanorama(boolean to_max, boolean cancel, boolean cancel_by_settings) throws InterruptedException {
        ...
        View shareButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.share);
        View settingsButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.settings);
        View cancelPanoramaButton = mActivity.findViewById(com.federicoterzi.opencamerastudio.R.id.cancel_panorama);
